...
private:
	...
	char padding_after_m_Velocity[8]; // DO NOT REMOVE! This extra padding is needed for protection against memory corruption on X64 platform. https://github.com/betavr/steamvr_driver_hydra/issues/18
